...
SALUN_ORACLE_GAP_KEEP_GRID_30_50_30="${SALUN_ORACLE_GAP_KEEP_GRID_30_50_30:-0.50 0.55 0.60 0.65}"
SALUN_ORACLE_GAP_KEEP_GRID_30_50_40="${SALUN_ORACLE_GAP_KEEP_GRID_30_50_40:-0.45 0.50 0.55 0.60}"
SALUN_ORACLE_GAP_KEEP_GRID_30_50_50="${SALUN_ORACLE_GAP_KEEP_GRID_30_50_50:-0.40 0.45 0.50 0.55}"
SALUN_ORACLE_GAP_LR_GRID_30_50_30="${SALUN_ORACLE_GAP_LR_GRID_30_50_30:-0.018 0.020 0.022 0.024}"
SALUN_ORACLE_GAP_LR_GRID_30_50_40="${SALUN_ORACLE_GAP_LR_GRID_30_50_40:-0.018 0.020 0.022 0.024}"
SALUN_ORACLE_GAP_LR_GRID_30_50_50="${SALUN_ORACLE_GAP_LR_GRID_30_50_50:-0.018 0.020 0.022 0.024}"
SALUN_ORACLE_GAP_EPOCH_GRID_30_50="${SALUN_ORACLE_GAP_EPOCH_GRID_30_50:-10}"
...
apply_salun_grid_preset() {
  ...
  case "${SALUN_GRID_PRESET}" in
    ...
    paper_20_50_keep_04_06)
      ...
      ;;
    oracle_gap_refine_30_50)
      SALUN_KEEP_GRID[30]="${SALUN_ORACLE_GAP_KEEP_GRID_30_50_30}"
      SALUN_KEEP_GRID[40]="${SALUN_ORACLE_GAP_KEEP_GRID_30_50_40}"
      SALUN_KEEP_GRID[50]="${SALUN_ORACLE_GAP_KEEP_GRID_30_50_50}"
      SALUN_LR_GRID[30]="${SALUN_ORACLE_GAP_LR_GRID_30_50_30}"
      SALUN_LR_GRID[40]="${SALUN_ORACLE_GAP_LR_GRID_30_50_40}"
      SALUN_LR_GRID[50]="${SALUN_ORACLE_GAP_LR_GRID_30_50_50}"
      for ratio in 30 40 50; do
        SALUN_EPOCH_GRID[$ratio]="${SALUN_ORACLE_GAP_EPOCH_GRID_30_50}"
        unset "SALUN_CANDIDATE_SPECS[$ratio]"
      done
      ;;
    *)
      echo "Unknown SALUN_GRID_PRESET: ${SALUN_GRID_PRESET}" >&2
      echo "Supported presets: ratio_tuned, paper_20_50_keep_04_06, oracle_gap_refine_30_50" >&2
      exit 1
      ;;
  esac
}
